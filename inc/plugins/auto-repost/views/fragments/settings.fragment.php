                ...
                <div class="col s12 m8 l4">
                    <section class="section mb-20">
                        ...
                        <div class="section-content">
                            ...
                            <ul class="field-tips">
                                <li><?= __("These values indicates maximum amount of the requests per day. They are not exact values. Depending on the server overload and delays between the requests, actual number of the requests might be less than these values.") ?></li>
